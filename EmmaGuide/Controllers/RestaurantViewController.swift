...
class RestaurantViewController: UIViewController, UIScrollViewDelegate {
    ...
    //Elements in LocationAddressView
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        // Animation when pulling down: Image will enlarge
        if offset < 0 {
        ...
        // Animation when scrolling down: Header will shrink, image will blur and entity name transform to white text
    ...
    //Setup locationAddressView for a centered address under Black Label
